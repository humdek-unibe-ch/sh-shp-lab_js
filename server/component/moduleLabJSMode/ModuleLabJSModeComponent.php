...
require_once __DIR__ . "/../moduleLabJS/ModuleLabJSView.php";
require_once __DIR__ . "/../moduleLabJS/ModuleLabJSModel.php";
require_once __DIR__ . "/../moduleLabJS/ModuleLabJSController.php";

/**
 * The class to define the asset select component.
 */
class ModuleLabJSModeComponent extends BaseComponent
{
    /* Constructors ***********************************************************/
